...
impl<'tcx> LateLintPass<'tcx> for UselessFormat {
    fn check_expr(&mut self, cx: &LateContext<'tcx>, expr: &'tcx Expr<'_>) {
        ...
        //
        // `first_node_in_macro` runs first: it rejects nodes in the middle of an expansion
        // without walking the expansion chain, while `matching_root_macro_call` always walks
