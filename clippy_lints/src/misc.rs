...
/// Contexts the underscore lints ignore. All three checks walk expansion data or parent nodes,
/// so the callers only run this once an underscore-prefixed name has actually been found.
